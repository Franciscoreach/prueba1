...
class RoosterDetail extends StatefulWidget {
  const RoosterDetail({super.key});

  @override
  State<RoosterDetail> createState() => _RoosterDetailState();
}

class _RoosterDetailState extends State<RoosterDetail> {
  @override
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                  image: AssetImage("assets/img/rooster_2.png"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
